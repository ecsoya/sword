...
public class M5cMobileService {
	...
	public M5cResult sendMessage(String mobile, String content) {
		...
		String username = properties.getUsername(); // 用户名

		String password_md5 = Md5Utils.hash(properties.getPassword()); // 密码

		String apikey = properties.getApiKey(); // apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
